  ...
  return (
    <div className="bg-center bg-cover bg-no-repeat bg-heroBgImg relative overflow-hidden">
      ...
      <div className=" container pt-[230px] pb-[226px] max-lg:py-44 max-md:py-24 max-sm:py-20 relative max-xl:z-20">
        <p className="text-white text-shadow text-customXl font-bold leading-[21px] max-md:text-center">
          Shape the future of Implenia!
        </p>
        <h1 className="text-shadow relative z-20 max-md:text-center text-white max-w-[727px] text-custom3Xl font-bold leading-[80px] max-lg:text-6xl max-md:text-5xl max-sm:text-4xl">
          WE ARE LOOKING FOR YOUR IDEA
        </h1>
        <button className="mt-6 shadow-[0px_4px_4px_0px_#00000040] max-md:mx-auto max-sm:h-[47px] border border-solid border-white text-white text-customXl font-bold leading-[21px] min-w-[312px] max-md:min-w-[270px] max-md:h-[57px] max-sm:min-w-[245px] h-[67px] rounded-full flex items-center justify-center transition-all ease-linear duration-300 hover:bg-black">
